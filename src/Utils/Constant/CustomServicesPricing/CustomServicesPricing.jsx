...
const CustomServicesPricing = ({ pricingData, limit }) => {
  const displayPricingCards = limit ? pricingData.slice(0, limit) : pricingData;
...
export default CustomServicesPricing;
